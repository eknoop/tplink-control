...
class BulbSchedule extends Schedule {
   ...
   */
  addRule({ lightState, start, daysOfWeek, name = '', enable = true }, sendOptions) {
    var _this = this;
   ...
   * @return {Promise<Object, ResponseError>} parsed JSON response
   */
  editRule({ id, lightState, start, daysOfWeek, name = '', enable = true }, sendOptions) {
    var _this2 = this;
    ...
    return _asyncToGenerator(function* () {
      ...
      return Schedule.prototype.editRule.call(_this2, rule, sendOptions); // super.addRule(rule); // workaround babel bug
    })();
  }
}
