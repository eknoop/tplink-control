...
class Bulb extends Device {
  ...
  getInfo(sendOptions) {
    ...
    return _asyncToGenerator(function* () {
      ...
      let data = yield _this.send(`{"${_this.apiModuleNamespace.emeter}":{"get_realtime":{}},"${_this.apiModuleNamespace.lightingservice}":{"get_light_state":{}},"${_this.apiModuleNamespace.schedule}":{"get_next_action":{}},"system":{"get_sysinfo":{}},"${_this.apiModuleNamespace.cloud}":{"get_info":{}}}`, sendOptions);
  ...
  getPowerState(sendOptions) {
    ...
    return _asyncToGenerator(function* () {
      let lightState = yield _this2.lighting.getLightState(sendOptions);
  ...
  setPowerState(value, sendOptions) {
    ...
    return _asyncToGenerator(function* () {
      return _this3.lighting.setLightState({ on_off: value ? 1 : 0 }, sendOptions);
    })();
  }
  /**
