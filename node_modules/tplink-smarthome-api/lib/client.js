...
const encrypt = _require.encrypt,
...
class Client extends EventEmitter {
  ...
  getSysInfo(host, port = 9999, sendOptions) {
    ...
    return _asyncToGenerator(function* () {
      _this3.log.debug('client.getSysInfo(%j)', { host, port, sendOptions });
      let data = yield _this3.send('{"system":{"get_sysinfo":{}}}', host, port, sendOptions);
  ...
  getDevice(deviceOptions, sendOptions) {
    ...
    return _asyncToGenerator(function* () {
      let sysInfo = yield _this4.getSysInfo(deviceOptions.host, deviceOptions.port, sendOptions);
      return _this4.getDeviceFromSysInfo(sysInfo, Object.assign({}, deviceOptions, { client: _this4 }));
    })();
  }
  /**
