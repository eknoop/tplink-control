...
const ResponseError = _require.ResponseError;
...
class Device extends EventEmitter {
  ...
  send(payload, sendOptions) {
    ...
    return _asyncToGenerator(function* () {
      ...
      let thisSendOptions = Object.assign({}, _this.defaultSendOptions, sendOptions);
      return _this.client.send(payload, _this.host, _this.port, thisSendOptions).catch(function (reason) {
  ...
  sendCommand(command, sendOptions) {
    ...
    return _asyncToGenerator(function* () {
      ...
      let response = yield _this2.send(commandObj, sendOptions);
  ...
  getSysInfo(sendOptions) {
    ...
    return _asyncToGenerator(function* () {
      _this3.log.debug('[%s] device.getSysInfo()', _this3.alias);
      _this3.sysInfo = yield _this3.sendCommand('{"system":{"get_sysinfo":{}}}', sendOptions);
      return _this3.sysInfo;
    })();
  }
  /**
  ...
  setAlias(alias, sendOptions) {
    ...
    return _asyncToGenerator(function* () {
      yield _this4.sendCommand({
        [_this4.apiModuleNamespace.system]: { set_dev_alias: { alias: alias } }
      }, sendOptions);
      _this4.sysInfo.alias = alias;
      return true;
    })();
  }
  /**
  ...
  getModel(sendOptions) {
    ...
    return _asyncToGenerator(function* () {
      let sysInfo = yield _this6.getSysInfo(sendOptions);
  ...
  reboot(delay, sendOptions) {
    ...
    return _asyncToGenerator(function* () {
      return _this7.sendCommand({
        [_this7.apiModuleNamespace.system]: { reboot: { delay } }
      }, sendOptions);
    })();
  }
  /**
  ...
  reset(delay, sendOptions) {
    ...
    return _asyncToGenerator(function* () {
      return _this8.sendCommand({
        [_this8.apiModuleNamespace.system]: { reset: { delay } }
      }, sendOptions);
    })();
  }
}
